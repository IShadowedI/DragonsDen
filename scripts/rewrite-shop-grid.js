...
const products = [
  ...
  // Streaming (8)
  { id: 'dragon-s-shadow-obs-overlay-pack', cat: 'streaming', catLabel: 'Streaming &amp; OBS', name: "Dragon's Shadow OBS Overlay Pack", desc: 'Complete stream overlay set — webcam frame, alerts, panels, screens (starting, BRB, ending). Dark fantasy theme. PNG &amp; PSD sources.', price: 14.99, img: 'obs-overlay-pack', badge: 'Popular' },
